...
$lang = array_merge($lang, array(
	...
	'CANNOT_RENAME_FOLDER'		=> '此資料夾無法重新命名。',
	'CANNOT_REMOVE_FOLDER'		=> '此資料夾無法移除。',
	...
	'FIELD_INVALID_VALUE'				=> '欄位「%s」有一個無效的數值。',
	...
	'RECIPIENTS'						=> '收件人',
	'REGISTRATION'						=> '註冊',
	'RELEASE_MESSAGES'					=> '%s 釋出所有保留中的私人訊息 %s…如果有足夠的空間它們將被放置到合適的資料夾中並且重新排序。',
	'REMOVE_ADDRESS'					=> '移除地址',
