...
$lang = array_merge($lang, array(
	...
	'ALL_TOPICS'					=> '所有主題',
	'AND'							=> '和',
	'ANNOUNCEMENT_TITLE_GUESTS'		=> '訪客公告',
	'ANNOUNCEMENT_TITLE'			=> '網站公告',
	...
	'EDIT_POST'							=> '編輯文章',
	'EMAIL'								=> 'e-mail', // EMAIL_ADDRESS 的縮寫
	...
	'SELECT_FORUM'				=> '選擇一個版面',
	'SEND_EMAIL'				=> 'e-mail',				// 用於送出按鈕
	'SEND_EMAIL_USER'			=> 'e-mail',				// 用於： {L_SEND_EMAIL_USER} {USERNAME} -> e-mail 會員 X
	...
	'VARIANT_DATE_SEPARATOR'	=> ' / ',	// 用於日期格式的下拉式選單，例如： "Today, 13:37 / 01 Jan 2007, 13:37"… 加入一個相對的日期日曆日期。
	'VIEWED'					=> '已觀看',
	'VIEWING_FAQ'				=> '檢視問答集',
	...
	'datetime'			=> array(
		...
		'Mar'		=> '3月',
		'Apr'		=> '4月',
		'May_short'	=> '5月',	// 代表「5月」的簡稱。使用 May_short 因為在英語中短期和長期的日期是相同的五月。
		'Jun'		=> '6月',
		'Jul'		=> '7月',
		'Aug'		=> '8月',
		'Sep'		=> '9月',
